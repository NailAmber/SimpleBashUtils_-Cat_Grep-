...
"for s21_grep.c s21_grep.c Makefile FLAGS"
"for s21_grep.c FLAGS"
"-e for -e ^int s21_grep.c s21_grep.c Makefile FLAGS"
...
"-e int -si no_file.txt s21_grep.c no_file2.txt s21_grep.c"
...
let "COUNTER++"
if diff  <(grep $PARAM) <(./s21_grep $PARAM) -s > /dev/null
then
    let "SUCCESS++"
